...
- Use the [`logger`](https://cran.r-project.org/package=logger) package as the default logging framework. It is simple, works well in scripts and packages, and is a better default than ad-hoc `print()` or `message()` calls for diagnostic traces.
