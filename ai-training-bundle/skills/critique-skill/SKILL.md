---
name: critique-skill
description: Critique Agent Skill design quality against official specifications and best practices. Use when reviewing, auditing, or improving SKILL.md files and skill packages. Provides multi-dimensional scoring and actionable improvement suggestions.
license: MIT License Copyright AI4CI
metadata:
  original: skill_judge MIT License jjmartres/opencode
---
...
> **Good Skill = Expert-only Knowledge − What AI Model Already Knows**
...
- **What the AI Model already knows**: Basic concepts, standard library usage, common programming patterns, general best practices

When a Skill explains "what is PDF" or "how to write a for-loop", it's compressing knowledge the AI Model already has. This is **token waste** — context window is a public resource shared with system prompts, conversation history, other Skills, and user requests.
...
Same the model, different Skills loaded, becomes different experts.
...
| **Domain specific** | A range of options exist but modern domain specific frameworks are to be preferred |
...
The art of Skill design is maximizing Expert and domain specific content, using Activation sparingly, and eliminating Redundant ruthlessly.
...
- Explaining how to use common libraries or packages
...
- Explaining how to use bleeding edge home grown libraries or packages
...
3. Count paragraphs that are Expert vs Domain specific vs Activation vs Redundant
